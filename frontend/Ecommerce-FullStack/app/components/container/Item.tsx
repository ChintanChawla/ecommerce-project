...
const Item = async (props: Props) => {
    ...
    const products: any[] = [{"id":1,"name":"Sample Product","description":"This is a sample product description.","price":"99.99","discount":"10.00","category":"Items","seller_id":2},{"id":3,"name":"Sample Product 2","description":"This is a sample product description.","price":"929.99","discount":"10.00","category":"Items","seller_id":2},{"id":2,"name":"Sample Product 2","description":"This is a sample product description.","price":"1.99","discount":"10.00","category":"Items","seller_id":2}]
